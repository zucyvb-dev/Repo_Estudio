...
describe('Renta', () => {
  ...
  test('inicializa correctamente con valores', () => {
    const r = new Renta('R001', 'C001', 'P001', 'LINEAL', 5, 200, '2026-03-17', true);
  ...
  test('convierte valores inválidos en dias y costo a 0', () => {
    const r = new Renta('R002', 'C002', 'P002', 'POR_DIA', 'abc', 'xyz', '2026-03-18', false);
  ...
  test('devuelta se convierte a booleano', () => {
    const rTruthy = new Renta('R003', 'C003', 'P003', 'LINEAL', 3, 150, '2026-03-19', 'yes');
    const rFalsy = new Renta('R004', 'C004', 'P004', 'LINEAL', 2, 100, '2026-03-20', 0);
